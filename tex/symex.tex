...
\begin{mathpar}
  \inferrule*[Right=\textsc{Sequence}]
  {\langle S;c_1 \rangle\Yields\langle S_1;s_1 \rangle \\
  \langle S_1;c_2 \rangle\Yields\langle S_2;s_2 \rangle}
  {\langle S; \texttt{\textbf{$c_1$ $c_2$}}\rangle\Yields\langle S_2;s_2 \rangle}
\end{mathpar}
